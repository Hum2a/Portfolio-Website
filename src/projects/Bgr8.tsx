...
const mediaSection = {
  images: [
    {
      src: `/images/Bgr8/Homepage CTA.png`,
      title: 'Homepage CTA',
    ...
    {
      src: `/images/Bgr8/Mentee Dashboard.png`,
    ...
    {
      src: `/images/Bgr8/Live Messaging between mentor and mentee.png`,
    ...
    {
      src: `/images/Bgr8/Admin Panel Analytics.png`,
    ...
    {
      src: `/images/Bgr8/Admin Panel DB Query Terminal.png`,
    ...
    {
      src: `/images/Bgr8/Admin Panel User Management.png`,
    ...
    {
      src: `/images/Bgr8/Admin Panel Role Cards.png`,
    ...
    {
      src: `/images/Bgr8/Admin Verification Panel.png`,
    ...
    {
      src: `/images/Bgr8/Admin Enquiries Management.png`,
    ...
    {
      src: `/images/Bgr8/Admin Email Drafter.png`,
    ...
    {
      src: `/images/Bgr8/Announcement Banner Manager.png`,
...
const businessFeatures = [
  { name: '🤝 Mentor Matching', description: 'Proprietary MentorAlgorithm with weighted scoring across 70+ criteria for intelligent mentor-mentee matching' },
  { name: '📅 Cal.com Integration', description: 'Real-time calendar integration for seamless booking and availability management' },
  { name: '📊 Admin Analytics', description: 'Comprehensive admin dashboard with detailed analytics and user management tools' },
  { name: '🔒 Security', description: 'Multi-layered security with CSP headers, XSS protection, and rate limiting' },
  { name: '🔍 Smart Search', description: 'Intelligent search and filtering system for finding the perfect mentor match' },
  { name: '📱 Responsive Design', description: 'Mobile-first responsive design for seamless experience across all devices' },
];
