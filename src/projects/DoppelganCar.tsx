...
const DoppelganCar = () => {
  ...
  const images = [
    { src: `/images/DoppelganCar/Homepage.png`, caption: "Homepage" },
    { src: `/images/DoppelganCar/Upload.png`, caption: "Upload and Analyze" },
    { src: `/images/DoppelganCar/Results.png`, caption: "Car Match Results" },
    { src: `/images/DoppelganCar/MobileView.png`, caption: "Mobile-Friendly UI" },
  ].map((image) => ({
    ...image,
