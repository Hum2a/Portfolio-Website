...
const projects = [
  {
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/SpZero/Home Page - Overview (Full).png`, caption: "SpZero Homepage - Complete platform overview showcasing the modern, gradient-based design" },
      { type: "image", src: `/images/LifeSmart/SpZero/Home Page - Overview.png`, caption: "Homepage Hero Section - Clean and inviting entry point to financial education" },
      { type: "image", src: `/images/LifeSmart/SpZero/Module Road Layout.png`, caption: "Interactive Learning Path - Visual module progression with 4 main areas: Foundations of Money, Personal Finance, Credit & Debt, and Investing" },
      { type: "image", src: `/images/LifeSmart/SpZero/Video Modal.png`, caption: "Video Content Player - Full-screen video player with progress tracking and seamless navigation" },
      { type: "image", src: `/images/LifeSmart/SpZero/Slides Modal.png`, caption: "Presentation Viewer - Interactive slide viewer for educational content with navigation controls" },
      { type: "image", src: `/images/LifeSmart/SpZero/Video and Slide Progress Saving.png`, caption: "Progress Tracking System - Automatic save functionality preserving user progress across sessions" },
      { type: "image", src: `/images/LifeSmart/SpZero/Admin Analytics General Stats.png`, caption: "Admin Analytics Dashboard - Comprehensive overview of user engagement, content performance, and system metrics" },
      { type: "image", src: `/images/LifeSmart/SpZero/Admin Analytics Content Drilldown.png`, caption: "Content Analytics Drilldown - Detailed analytics for modules, sections, and topics with engagement heatmaps" },
      { type: "image", src: `/images/LifeSmart/SpZero/Admin User Focused Analytics.png`, caption: "User-Centric Analytics - Individual user tracking, activity logs, and learning progress monitoring" },
      { type: "image", src: `/images/LifeSmart/SpZero/Admin Module Management.png`, caption: "Content Management Interface - Full CRUD operations with drag-and-drop module reordering and content organization" },
    ],
  },
  {
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/SpZero Calculator/SpZero I frame calculator.png`, caption: "SpZero Calculator Widget - Professional iframe calculator embedded on SPZeroFinance website showing credit card interest calculations and investment growth projections" },
    ],
  },
  {
    id: "misc",
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/Misc/HomeScreen.png`, caption: "Home Screen" },
      { type: "image", src: `/images/LifeSmart/Misc/SelectScreen.png`, caption: "Tool Selection Screen" },
      { type: "image", src: `/images/LifeSmart/Misc/Login.png`, caption: "Login Interface" },
      { type: "image", src: `/images/LifeSmart/Misc/Admin Dashboard.png`, caption: "Admin Dashboard" },
    ],
  },
  {
    id: "financial-quiz",
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/Quiz/LandingPage.png`, caption: "Quiz Landing Page" },
      { type: "image", src: `/images/LifeSmart/Quiz/Quizcreation.png`, caption: "Quiz Creation Page" },
      { type: "image", src: `/images/LifeSmart/Quiz/Question 1.png`, caption: "Question 1 Example" },
      { type: "image", src: `/images/LifeSmart/Quiz/Question 1 answered.png`, caption: "Answered Question" },
      { type: "video", src: `/videos/LifeSmart/Quiz/Highlighted words.mp4`, caption: "Highlighted Words Feature" },
      { type: "video", src: `/videos/LifeSmart/Quiz/Scoreboard video.mp4`, caption: "Scoreboard Feature Demo" },
    ],
  },
  {
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/Asset Simulation/Homepage.png`, caption: "Homepage" },
      { type: "image", src: `/images/LifeSmart/Asset Simulation/Results.png`, caption: "Simulation Results" },
      { type: "video", src: `/videos/LifeSmart/Asset Simulation/Simulation.mp4`, caption: "Simulation in Action" },
    ],
  },
  {
    id: "budget-tool",
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step1.png`, caption: "Step 1: Income Input" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step2.png`, caption: "Step 2: Needs Expenses" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step3.png`, caption: "Step 3: Wants Expenses" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step4no.png`, caption: "Step 4: Savings Details" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step4yes.png`, caption: "Step 4: Savings Input" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step5.png`, caption: "Step 5: Budget Review" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step6.png`, caption: "Step 6: 6 Month Projection" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/Step7.png`, caption: "Step 7: Final Spreadsheet" },
      { type: "image", src: `/images/LifeSmart/Budget Tool/ExcelSpreadsheet.png`, caption: "Excel Export Example" },
    ],
  },
  {
    ...
    media: [
      { type: "image", src: `/images/LifeSmart/Investment Calculator/Investment Calculator.png`, caption: "Investment Calculator" },
    ],
  },
  {
    id: "buzzer",
